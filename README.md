...
Specific Error Case : Running Client in client
...
Quantum Running for 1 program



8.	Switching Between Processes


9. Increasing Quantum after each round for each process 
...
10. Priority Comes Up and Starts running 


11. Running single commands



12. Interrupting the running processes

(Shortest Job first)

13. Time error checking 
